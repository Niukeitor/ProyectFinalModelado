...
var Respuesta_1 = require("./Respuesta");
var Preguntas = /** @class */ (function (_super) {
    ...
    ], Preguntas.prototype, "id");
    __decorate([
        typeorm_1.OneToMany(function () { return Preguntado_1.Preguntado; }, function (preguntado) { return preguntado.preguntas; }),
        __metadata("design:type", Preguntado_1.Preguntado)
    ], Preguntas.prototype, "preguntado");
    __decorate([
        typeorm_1.OneToOne(function () { return Respuesta_1.Respuesta; }, function (respuesta) { return respuesta.pregunta; }),
